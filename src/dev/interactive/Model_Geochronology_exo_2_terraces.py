...
import os, sys
dir_root = "/home/fclapuyt/Documents/repos/cosmo-training/"
sys.path.append(dir_root)

from src.functions.compute_nash_index import compute_nash_index
...
# parameters["rho"] = 2.7                        # bulk density for Granite
...
def be_accumulator(concentrations_observed, depths_observed, t_exp, erosion_cm, N_inh, parameters):
    ...
    result = {
        ...
        "crn_fit": relevant_CRN_to_fit_reality_Be
    }
...
concentrations_observed = np.array([150000, 120000, 110000, 103000])
sd_concentrations_observed = np.array([])

# Write the depth corresponding to each 10Be value mentioned above in cm
depths_observed = [100,170,230,300]
...
for i in range(len(erosion)):
    ...
    for j in range(len(age)):
        ...
        crn_fit = be_accumulator(concentrations_observed, depths_observed, age[j], erosion[i], 20000, parameters)
